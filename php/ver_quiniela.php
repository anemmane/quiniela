...
<div class="contenedor_descarga">
    <table width="906px" background="../img/fondo_quiniela.jpg" style="background-size: 100% 100%" id="datos_quiniela">
        <tr>
            <th colspan="25" width="906px" height="92px"></th>
        </tr>
        ...
        $query = "select*from tbl_quinielas WHERE id_quiniela='".$id_quiniela."' ";
        $ejecutar = mysqli_query($conexion, $query);
        while($row=mysqli_fetch_assoc($ejecutar)){
        ...
        <!--Linea 1 de partidos-->    
        <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p1_a1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p1_a2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p1; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p1; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p7_b1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p7_b2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p7; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p7; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p13_c1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p13_c2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p13; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p13; ?></td>
            <td width=16 height=28></td>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p2_a3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p2_a4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p2; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p2; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p8_b3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p8_b4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p8; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p8; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p14_c3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p14_c4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p14; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p14; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p3_a1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p3_a3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p3; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p3; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p9_b4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p9_b2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p9; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p9; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p15_c4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p15_c2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p15; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p15; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p4_a4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p4_a2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p4; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p4; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p10_b1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p10_b3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p10; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p10; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p16_c1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p16_c3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p16; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p16; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p5_a2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p5_a3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p5; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p5; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p12_b2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p12_b3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p12; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p12; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p17_c4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p17_c1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p17; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p17; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p6_a4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p6_a1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p6; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p6; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p11_b4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p11_b1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p11; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p11; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p18_c2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p18_c3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p18; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p18; ?></td>
            <td width=16 height=28></td>
        </tr>

        <tr>
            <th colspan="25" height="20px"></th>
        </tr>

                <!--Linea 7 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p19_d1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p19_d2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p19; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p19; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p25_e1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p25_e2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p25; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p25; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p31_f3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p31_f4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p31; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p31; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p20_d3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p20_d4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p20; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p20; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p26_e3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p26_e4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p26; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p26; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p32_f1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p32_f2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p32; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p32; ?></td>
            <td width=16 height=28></td>
        </tr>
                ...
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p21_d2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p21_d4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p21; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p21; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p27_e2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p27_e4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p27; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p27; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p33_f1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p33_f3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p33; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p33; ?></td>
            <td width=16 height=28></td>
        </tr>

                <!--Linea 10 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p22_d3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p22_d1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p22; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p22; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p28_e3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p28_e1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p28; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p28; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p34_f4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p34_f2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p34; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p34; ?></td>
            <td width=16 height=28></td>
        </tr>

                <!--Linea 11 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p24_d2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p24_d3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p24; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p24; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p29_e2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p29_e3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p29; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p29; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p35_f4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p35_f1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p35; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p35; ?></td>
            <td width=16 height=28></td>
        </tr>

                <!--Linea 12 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p23_d4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p23_d1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p23; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p23; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p30_e4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p30_e1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p30; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p30; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28><?php echo $row['quiniela_p36_f2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p36_f3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p36; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p36; ?></td>
            <td width=16 height=28></td>
        </tr>
        ...
        <tr>
            <th colspan="25" height="20px"></th>
                ...
                <!--Linea 13 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p37_g3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p37_g4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p37; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p37; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p43_h3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p43_h4']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p43; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p43; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
     <td width=16 height=28></td>
            ...
            <td width=16 height=28></td>
                ...
                <!--Linea 14 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p38_g1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p38_g2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p38; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p38; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p44_h1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p44_h2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p44; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p44; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            ...
            <td width=16 height=28></td>
                ...
                <!--Linea 15 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p39_g4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p39_g2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p39; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p39; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p45_h4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p45_h2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p45; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p45; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=100 height=28>Aciertos por resultados :<?php echo $suma_resultado; ?></td>
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=16 height=28></td>
                ...
                <!--Linea 16 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p40_g1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p40_g3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p40; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p40; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p46_h1']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p46_h3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p46; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p46; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=100 height=28>Aciertos por goles :<?php echo $suma_goles; ?></td>
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=16 height=28></td>
                ...
                <!--Linea 17 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p41_g2']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p41_g3']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p41; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p41; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p48_h4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p48_h1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p48; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p48; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=100 height=28>Aciertos totales :<?php echo $suma_total; ?></td>
            <td width=16 height=28></td>
            <td width=10 height=28></td>
            <td width=16 height=28></td>
            <td width=16 height=28></td>
                ...
                <!--Linea 18 de partidos-->    
                <tr width=906 height=28>
            <td width=120 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p42_g4']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p42_g1']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p42; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p42; ?></td>
            <td width=100 height=28></td>
            <!--Segunda columna -->
            <td width=16 height=28><?php echo $row['quiniela_p47_h3']; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $row['quiniela_p47_h2']; ?></td>
            <td width=100 height=28></td>
            <td width=16 height=28><?php echo $resultado_p47; ?></td>
            <td width=10 height=28></td>
            <td width=16 height=28><?php echo $goles_p47; ?></td>
            <td width=100 height=28></td>
            <!--Tercera columna -->
            <td width=16 height=28></td>
            <td width=10 height=28></td>
