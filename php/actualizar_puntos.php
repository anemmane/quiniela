...
<div class="contenedor_tabla">
    <table id="datos_tabla">
        <tr>
            ...
            <th>Actualizar aciertos en BD</th>
        </tr>
...
<tr>
            <td><?php echo $row['id_quiniela']; $id_quiniela_control = $row['id_quiniela']; ?></td>
            <td><?php echo $row['quiniela_usuario']; ?></td>
            <td><?php echo $row['quiniela_codigo']; $quiniela_codigo_control = $row['quiniela_codigo'];  ?></td>
            <td><?php echo $suma_total; ?></td>
            <td><a href="../php/ver_quiniela.php?id=<?php echo $row['id_quiniela']; ?>">Descargar</a></td>
            <td><a href="../php/subir_actualizacion.php?id=<?php echo $suma_total ?>&idquiniela=<?php echo $id_quiniela_control ?>">Actualizar</a></td>
        </tr>
